...
/**
 * VisitKőszeg Clean Apple-Style Logo
 */
...
export default function VisitKoszegLogo({ className = "" }) {
  return (
    <div className={`inline-flex items-center gap-2 select-none ${className}`}>
      <VisitKoszegIcon className="w-6 h-7" color="#d97706" />
      <div className="flex items-baseline font-semibold tracking-tight text-xl">
        <span className="font-light text-zinc-900 dark:text-zinc-100">visit</span>
        <span className="font-bold text-amber-600 dark:text-amber-500">koszeg</span>
      </div>
    </div>
  );
}
