...
export default function ExhibitorCard({ exhibitor, items }) {
  return (
    <div className="bg-white border border-stone-200/90 rounded-3xl p-6 shadow-sm mb-6 space-y-6">
      {/* Header Info */}
      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 pb-4 border-b border-stone-100">
        <div className="space-y-1.5">
          ...
          {exhibitor.cause && (
            <div className="inline-flex items-center gap-1.5 text-xs text-rose-900 bg-rose-50 px-3 py-1.5 rounded-xl border border-rose-200 font-semibold mt-2">
      ...
      {exhibitor.notice && (
        <div className="bg-stone-50 border border-stone-200 px-4 py-2.5 rounded-2xl flex items-center gap-2.5 text-xs font-semibold text-stone-800">
