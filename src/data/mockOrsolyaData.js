...
export const INITIAL_EXHIBITORS = [
  ...
  },
  {
    ...
    email: 'vadaszok@koszeg.hu',
    facebook_url: '',
    instagram_url: '',
    image: 'https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=800&q=80',
    notice: 'Erdei szarvaspörkölt dödöllével kész Vasárnap!'
  },
  {
    id: 'ex-6',
...
export const INITIAL_MENU_ITEMS = [
  {
    ...
    status: 'ready',
    votes: 42,
    tags: ['Meleg ételek', 'Bográcsos', 'Pörkölt'],
    category: 'meleg_etel',
    available_day: 'both',
  ...
  },
  {
    id: 'item-102',
    exhibitor_id: 'ex-1',
    name: 'Gluténmentes Szüretes Gulyásleves',
    description: 'Gazdag gulyásleves füstölt csülökkel és gluténmentes csipetkével.',
    status: 'ready',
    votes: 38,
    tags: ['Meleg ételek', 'Gulyás', 'Gluténmentes'],
    category: 'meleg_etel',
  ...
  },
  {
    ...
    status: 'ready',
    votes: 29,
    tags: ['Meleg ételek', 'Gulyás', 'Babgulyás'],
    category: 'meleg_etel',
    available_day: 'both',
    is_gluten_free: false,
  ...
  },
  {
    id: 'item-501',
    exhibitor_id: 'ex-5',
    name: 'Gluténmentes Vasi Dödölle Pirított Hagymával',
    description: 'Burgonyás dödölle ropogósra pirítva, fokhagymás tejföllel.',
    status: 'ready',
    votes: 47,
    tags: ['Meleg ételek', 'Dödölle', 'Gluténmentes'],
    category: 'meleg_etel',
